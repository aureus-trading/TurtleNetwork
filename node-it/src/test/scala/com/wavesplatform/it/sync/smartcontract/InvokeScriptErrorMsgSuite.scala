  ...
  test("error message is informative") {
    ...
    assertApiError(
      ...
      AssertiveApiError(
        ...
        "Error while executing dApp: Fee in TN for InvokeScriptTransaction (14000000 in TN) with 12 total scripts invoked does not exceed minimal value of 54000000 TN."
      )
    )
  }
}
