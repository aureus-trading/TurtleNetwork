...
object TxHelpers {
  ...
  def genesis(address: Address, amount: Long = 2000_00_000_000L.waves): GenesisTransaction =
  ...
  def issue(amount: Long = 1000, script: Script = null): IssueTransaction =
    IssueTransaction
      .selfSigned(TxVersion.V2, defaultSigner, "test", "", amount, 0, reissuable = true, Option(script), 1000.waves, timestamp)
      .explicitGet()
